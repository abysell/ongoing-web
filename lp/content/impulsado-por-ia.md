...
## 2. CONTENIDO COPYWRITING (Español)

### [HERO SECTION]
* **H1 (Headline):** Gobierna y opera tu empresa conversando con ella. (Pruébalo ahora, sin registros).
...
### [EL PROBLEMA]
* **Subtítulo:** El software tradicional te da datos sueltos. OnGoing te da dirección activa.
* **Cuerpo de texto:** Pierdes hasta un 30% de tu semana solicitando reportes. OnGoing V2 elimina a los intermediarios entre tú y la información crítica de tu empresa.

### [EL FACTOR KAI]
* **Título:** KAI: Tu nuevo Asistente Ejecutivo de IA
* **Descripción:** Entra a *demo.ongoing2.mx* y escríbele a KAI tú mismo:
    * *Consulta:* "KAI, dame el flujo de caja neto de este mes."
    * *Ejecuta:* "Registra a 'Distribuidora Norte' con un trato de $50,000 MXN."

### [EL ECOSISTEMA ONGOING: MUCHO MÁS QUE IA]
* **Título:** Todo lo que tu empresa necesita en una sola suscripción.
* **Cuerpo de texto:** Al activar tu cuenta, no solo obtienes a KAI. Desbloqueas un ecosistema empresarial completo y conectado nativamente:
    * 🤝 **CRM B2B:** Embudos de venta, contactos y cotizaciones.
    * 📦 **Multialmacén:** Control de stock y órdenes de compra automáticas.
    * 💼 **Gestión de Proyectos (PSA):** Hitos, tareas y costeo de horas.
    * 🧾 **Finanzas y Facturación:** Flujo de caja y timbrado CFDI 4.0 directo al SAT.
